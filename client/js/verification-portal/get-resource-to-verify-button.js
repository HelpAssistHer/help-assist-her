...
const updateForm = ({ changeFieldValue, resource }) => {
	...
	changeFieldValue('hours.sunday.open', convertNumberToTimeFormat(_.get(hours, '[0].open')))
	changeFieldValue('hours.sunday.close', convertNumberToTimeFormat(_.get(hours, '[0].close')))
	changeFieldValue('hours.monday.open', convertNumberToTimeFormat(_.get(hours, '[1].open')))
	changeFieldValue('hours.monday.close', convertNumberToTimeFormat(_.get(hours, '[1].close')))
	changeFieldValue('hours.tuesday.open', convertNumberToTimeFormat(_.get(hours, '[2].open')))
	changeFieldValue('hours.tuesday.close', convertNumberToTimeFormat(_.get(hours, '[2].close')))
	changeFieldValue('hours.wednesday.open', convertNumberToTimeFormat(_.get(hours, '[3].open')))
	changeFieldValue('hours.wednesday.close', convertNumberToTimeFormat(_.get(hours, '[3].close')))
	changeFieldValue('hours.thursday.open', convertNumberToTimeFormat(_.get(hours, '[4].open')))
	changeFieldValue('hours.thursday.close', convertNumberToTimeFormat(_.get(hours, '[4].close')))
	changeFieldValue('hours.friday.open', convertNumberToTimeFormat(_.get(hours, '[5].open')))
	changeFieldValue('hours.friday.close', convertNumberToTimeFormat(_.get(hours, '[5].close')))
	changeFieldValue('hours.saturday.open', convertNumberToTimeFormat(_.get(hours, '[6].open')))
	changeFieldValue('hours.saturday.close', convertNumberToTimeFormat(_.get(hours, '[6].close')))
