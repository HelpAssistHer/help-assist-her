...
import LocationIcon from './icons/icon-components/location-icon'
import PhoneIcon from './icons/icon-components/phone-icon'
import GlobeIcon from './icons/icon-components/globe-icon'
