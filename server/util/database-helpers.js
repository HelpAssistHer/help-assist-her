...
module.exports = {
	...
	updatePregnancyCenterDoNotList: async (userId, pregnancyCenterId, doNotListObj) => {
		// validate doNotListObj as true or false
		const validatedDoNotListObj = await validateDocument(locationSchemaJoi.doNotListSchemaJoi, doNotListObj)
		...
		// create separate history document
		await createPregnancyCenterHistory(pregnancyCenterId, 'doNotList', newValue, oldValue, userId)
